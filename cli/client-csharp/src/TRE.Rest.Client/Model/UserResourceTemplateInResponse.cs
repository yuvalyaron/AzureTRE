...
namespace TRE.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserResourceTemplateInResponse")]
    public partial class UserResourceTemplateInResponse : IEquatable<UserResourceTemplateInResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserResourceTemplateInResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserResourceTemplateInResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserResourceTemplateInResponse" /> class.
        /// </summary>
        ...
        /// <param name="parentWorkspaceService">Bundle name (required).</param>
        public UserResourceTemplateInResponse(string id = default(string), string name = default(string), string title = "", string description = default(string), string version = default(string), ResourceType resourceType = default(ResourceType), bool current = default(bool), string type = "object", Collection<string> required = default(Collection<string>), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Collection<CustomAction> actions = default(Collection<CustomAction>), Collection<CustomAction> customActions = default(Collection<CustomAction>), Object pipeline = default(Object), bool additionalProperties = false, Dictionary<string, Property> systemProperties = default(Dictionary<string, Property>), string parentWorkspaceService = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null) {
                throw new ArgumentNullException("description is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            this.Description = description;
            // to ensure "version" is required (not null)
            if (version == null) {
                throw new ArgumentNullException("version is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            ...
            if (required == null) {
                throw new ArgumentNullException("required is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            this.Required = required;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            this.Properties = properties;
            // to ensure "systemProperties" is required (not null)
            if (systemProperties == null) {
                throw new ArgumentNullException("systemProperties is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            this.SystemProperties = systemProperties;
            // to ensure "parentWorkspaceService" is required (not null)
            if (parentWorkspaceService == null) {
                throw new ArgumentNullException("parentWorkspaceService is a required property for UserResourceTemplateInResponse and cannot be null");
            }
            this.ParentWorkspaceService = parentWorkspaceService;
        ...
        [DataMember(Name = "parentWorkspaceService", IsRequired = true, EmitDefaultValue = false)]
        public string ParentWorkspaceService { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserResourceTemplateInResponse {\n");
            ...
            sb.Append("  ParentWorkspaceService: ").Append(ParentWorkspaceService).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UserResourceTemplateInResponse);
        }

        /// <summary>
        /// Returns true if UserResourceTemplateInResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UserResourceTemplateInResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserResourceTemplateInResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ParentWorkspaceService == input.ParentWorkspaceService ||
                    (this.ParentWorkspaceService != null &&
                    this.ParentWorkspaceService.Equals(input.ParentWorkspaceService))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParentWorkspaceService != null)
                {
                    hashCode = (hashCode * 59) + this.ParentWorkspaceService.GetHashCode();
                }
                return hashCode;
            }
        }
