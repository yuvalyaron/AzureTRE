...
namespace TRE.Rest.Client.Model
{
    ...
    public partial class ValidationError : IEquatable<ValidationError>, IValidatableObject
    {
        ...
        public ValidationError(Collection<string> loc = default(Collection<string>), string msg = default(string), string type = default(string))
        {
        ...
        public Collection<string> Loc { get; set; }
