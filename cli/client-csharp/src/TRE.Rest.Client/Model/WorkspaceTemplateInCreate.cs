...
namespace TRE.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkspaceTemplateInCreate")]
    public partial class WorkspaceTemplateInCreate : IEquatable<WorkspaceTemplateInCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceTemplateInCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkspaceTemplateInCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceTemplateInCreate" /> class.
        /// </summary>
        ...
        public WorkspaceTemplateInCreate(string name = default(string), string version = default(string), bool current = default(bool), Object jsonSchema = default(Object), Collection<CustomAction> customActions = default(Collection<CustomAction>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for WorkspaceTemplateInCreate and cannot be null");
            }
            this.Name = name;
            // to ensure "version" is required (not null)
            if (version == null) {
                throw new ArgumentNullException("version is a required property for WorkspaceTemplateInCreate and cannot be null");
            }
            this._Version = version;
            this.Current = current;
            // to ensure "jsonSchema" is required (not null)
            if (jsonSchema == null) {
                throw new ArgumentNullException("jsonSchema is a required property for WorkspaceTemplateInCreate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspaceTemplateInCreate {\n");
        ...
        {
            return this.Equals(input as WorkspaceTemplateInCreate);
        }

        /// <summary>
        /// Returns true if WorkspaceTemplateInCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkspaceTemplateInCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspaceTemplateInCreate input)
        {
            if (input == null)
            {
                return false;
