...
namespace TRE.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SharedService")]
    public partial class SharedService : IEquatable<SharedService>, IValidatableObject
    {
        ...
        public SharedService(string id = default(string), string templateName = default(string), string templateVersion = default(string), Object properties = default(Object), bool isActive = true, bool isEnabled = true, ResourceType? resourceType = default(ResourceType?), string etag = default(string), string resourcePath = "", int resourceVersion = 0, Object user = default(Object), decimal updatedWhen = 0M, Collection<ResourceHistoryItem> history = default(Collection<ResourceHistoryItem>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for SharedService and cannot be null");
            }
            this.Id = id;
            // to ensure "templateName" is required (not null)
            if (templateName == null) {
                throw new ArgumentNullException("templateName is a required property for SharedService and cannot be null");
            }
            this.TemplateName = templateName;
            // to ensure "templateVersion" is required (not null)
            if (templateVersion == null) {
                throw new ArgumentNullException("templateVersion is a required property for SharedService and cannot be null");
            }
            this.TemplateVersion = templateVersion;
            // to ensure "etag" is required (not null)
            if (etag == null) {
                throw new ArgumentNullException("etag is a required property for SharedService and cannot be null");
            }
            this.Etag = etag;
        ...
        {
            return this.Equals(input as SharedService);
        }

        /// <summary>
        /// Returns true if SharedService instances are equal
        /// </summary>
        /// <param name="input">Instance of SharedService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SharedService input)
        {
            if (input == null)
            {
                return false;
