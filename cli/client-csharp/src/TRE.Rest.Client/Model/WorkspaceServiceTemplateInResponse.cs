...
namespace TRE.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkspaceServiceTemplateInResponse")]
    public partial class WorkspaceServiceTemplateInResponse : IEquatable<WorkspaceServiceTemplateInResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceServiceTemplateInResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WorkspaceServiceTemplateInResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkspaceServiceTemplateInResponse" /> class.
        /// </summary>
        ...
        public WorkspaceServiceTemplateInResponse(string id = default(string), string name = default(string), string title = "", string description = default(string), string version = default(string), ResourceType resourceType = default(ResourceType), bool current = default(bool), string type = "object", Collection<string> required = default(Collection<string>), Dictionary<string, Property> properties = default(Dictionary<string, Property>), Collection<CustomAction> actions = default(Collection<CustomAction>), Collection<CustomAction> customActions = default(Collection<CustomAction>), Object pipeline = default(Object), bool additionalProperties = false, Dictionary<string, Property> systemProperties = default(Dictionary<string, Property>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for WorkspaceServiceTemplateInResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for WorkspaceServiceTemplateInResponse and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null) {
                throw new ArgumentNullException("description is a required property for WorkspaceServiceTemplateInResponse and cannot be null");
            }
            this.Description = description;
            // to ensure "version" is required (not null)
            if (version == null) {
                throw new ArgumentNullException("version is a required property for WorkspaceServiceTemplateInResponse and cannot be null");
            }
            ...
            if (required == null) {
                throw new ArgumentNullException("required is a required property for WorkspaceServiceTemplateInResponse and cannot be null");
            }
            this.Required = required;
            // to ensure "properties" is required (not null)
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for WorkspaceServiceTemplateInResponse and cannot be null");
            }
            this.Properties = properties;
            // to ensure "systemProperties" is required (not null)
            if (systemProperties == null) {
                throw new ArgumentNullException("systemProperties is a required property for WorkspaceServiceTemplateInResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkspaceServiceTemplateInResponse {\n");
        ...
        {
            return this.Equals(input as WorkspaceServiceTemplateInResponse);
        }

        /// <summary>
        /// Returns true if WorkspaceServiceTemplateInResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkspaceServiceTemplateInResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspaceServiceTemplateInResponse input)
        {
            if (input == null)
            {
                return false;
