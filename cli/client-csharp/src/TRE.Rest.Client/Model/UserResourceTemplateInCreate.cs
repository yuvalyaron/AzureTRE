...
namespace TRE.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserResourceTemplateInCreate")]
    public partial class UserResourceTemplateInCreate : IEquatable<UserResourceTemplateInCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserResourceTemplateInCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserResourceTemplateInCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserResourceTemplateInCreate" /> class.
        /// </summary>
        ...
        public UserResourceTemplateInCreate(string name = default(string), string version = default(string), bool current = default(bool), Object jsonSchema = default(Object), Collection<CustomAction> customActions = default(Collection<CustomAction>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for UserResourceTemplateInCreate and cannot be null");
            }
            this.Name = name;
            // to ensure "version" is required (not null)
            if (version == null) {
                throw new ArgumentNullException("version is a required property for UserResourceTemplateInCreate and cannot be null");
            }
            this._Version = version;
            this.Current = current;
            // to ensure "jsonSchema" is required (not null)
            if (jsonSchema == null) {
                throw new ArgumentNullException("jsonSchema is a required property for UserResourceTemplateInCreate and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserResourceTemplateInCreate {\n");
        ...
        {
            return this.Equals(input as UserResourceTemplateInCreate);
        }

        /// <summary>
        /// Returns true if UserResourceTemplateInCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of UserResourceTemplateInCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserResourceTemplateInCreate input)
        {
            if (input == null)
            {
                return false;
